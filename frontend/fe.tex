...
% Bibliography.
\usepackage[citestyle = authoryear, bibstyle = alphabetic, maxcitenames = 1, backend = biber]{biblatex}
...
\definecolor{thmcolor}{RGB}{117, 69, 117}
\newtheoremstyle{thmstyle}{}{}{\color{thmcolor}}{}{\color{thmcolor}\bfseries}{}{ }{}
\theoremstyle{thmstyle}
\newtheorem{thm}{Theorem}[section]
\newcommand{\thmref}[1]{{\color{thmcolor} Theorem #1}}

% -- Proof Environment Settings -- %
\definecolor{proofcolor}{RGB}{93, 69, 117}
\let\oldproof\proof
...
\newcommand{\defnref}[1]{{\color{defncolor} Definition #1}}
