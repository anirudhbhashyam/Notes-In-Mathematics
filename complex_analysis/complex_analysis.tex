...
where $\alpha \leq \tau \leq \beta.$ We have by variable substitution and above,
    ...
    \end{align*}
\end{proof}
The above theorem was important because of the discussion that is about to follow. We state the (practical) definiton of the complex contour integral as a theorem. 
\begin{thm}[Complex Contour Integral Usable]
